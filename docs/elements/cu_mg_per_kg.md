...
URI: [basalt_schema:cu_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/cu_mg_per_kg)
Alias: cu_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:cu_mg_per_kg |
| native | basalt_schema:cu_mg_per_kg |
