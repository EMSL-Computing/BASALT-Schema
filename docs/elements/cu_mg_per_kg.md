...
_Copper concentration in mg/kg_





URI: [analysis_api_schema:cu_mg_per_kg](https://w3id.org/MONet/analysis-api-schema/cu_mg_per_kg)
Alias: cu_mg_per_kg
...
| ---  | ---  |
| self | analysis_api_schema:cu_mg_per_kg |
| native | analysis_api_schema:cu_mg_per_kg |
