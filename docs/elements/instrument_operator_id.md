...
URI: [basalt_schema:instrument_operator_id](https://emsl-computing.github.io/BASALT-Schema/elements/instrument_operator_id)
...
| ---  | ---  |
| self | basalt_schema:instrument_operator_id |
| native | basalt_schema:instrument_operator_id |
