...
_A sampling activity where aerosol samples were collected._





URI: [analysis_api_schema:AerosolSamplingActivity](https://w3id.org/MONet/analysis-api-schema/AerosolSamplingActivity)
...
```mermaid
 classDiagram
    ...
    click AerosolSamplingActivity href "../AerosolSamplingActivity/"
      ...
      AerosolSamplingActivity : collection_time
        
      AerosolSamplingActivity : description
        
      AerosolSamplingActivity : emsl_activity
        
      AerosolSamplingActivity : humidity
      ...
      AerosolSamplingActivity : sample_collected
        
      AerosolSamplingActivity : sample_collection_dev
        
      AerosolSamplingActivity : sampled_at_site
      ...
      AerosolSamplingActivity : sampling_duration
        
      AerosolSamplingActivity : shipped_sample_size
        
      AerosolSamplingActivity : wind_direction
      ...
      AerosolSamplingActivity : wind_speed
...
| [humidity](humidity.md) | 0..1 <br/> [String](String.md) | Amount of water vapor measured in the air the day of sampling | direct |
...
| ---  | ---  |
| self | analysis_api_schema:AerosolSamplingActivity |
| native | analysis_api_schema:AerosolSamplingActivity |
