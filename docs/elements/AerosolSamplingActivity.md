...
URI: [basalt_schema:AerosolSamplingActivity](https://w3id.org/MONet/basalt-schema/AerosolSamplingActivity)
...
| ---  | ---  |
| self | basalt_schema:AerosolSamplingActivity |
| native | basalt_schema:AerosolSamplingActivity |
