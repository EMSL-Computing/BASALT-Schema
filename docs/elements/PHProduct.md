...
URI: [basalt_schema:PHProduct](https://emsl-computing.github.io/BASALT-Schema/elements/PHProduct)
...
```mermaid
 classDiagram
    ...
    click PHProduct href "../PHProduct/"
      ...
      PHProduct : md5checksum
        
      PHProduct : measure_type
      ...
      PHProduct : sample_name
        
      PHProduct : sampling_set
        
      PHProduct : summary_metrics
...
| [ph](ph.md) | 0..1 <br/> [Double](Double.md) |  | direct |
...
| ---  | ---  |
| self | basalt_schema:PHProduct |
| native | basalt_schema:PHProduct |
