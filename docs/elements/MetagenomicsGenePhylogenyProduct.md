...
_Top-level archive for gene-based phylogeny outputs (zip/tar stored in MinIO)._
...
URI: [basalt_schema:MetagenomicsGenePhylogenyProduct](https://emsl-computing.github.io/BASALT-Schema/elements/MetagenomicsGenePhylogenyProduct)
...
```mermaid
 classDiagram
    ...
    click MetagenomicsGenePhylogenyProduct href "../MetagenomicsGenePhylogenyProduct/"
      ...
      MetagenomicsGenePhylogenyProduct : core_section
      ...
      MetagenomicsGenePhylogenyProduct : description
        
      MetagenomicsGenePhylogenyProduct : filesize
        
      MetagenomicsGenePhylogenyProduct : gene_family
      ...
      MetagenomicsGenePhylogenyProduct : mg_workflow_step
      ...
      MetagenomicsGenePhylogenyProduct : name
        
      MetagenomicsGenePhylogenyProduct : project
        
      MetagenomicsGenePhylogenyProduct : provider_name
      ...
      MetagenomicsGenePhylogenyProduct : raw_fasta_url
        
      MetagenomicsGenePhylogenyProduct : s3_base_url
        
      MetagenomicsGenePhylogenyProduct : s3_bucket
        
      MetagenomicsGenePhylogenyProduct : s3_key
        
      MetagenomicsGenePhylogenyProduct : sample_id
      ...
      MetagenomicsGenePhylogenyProduct : sample_name
        
      MetagenomicsGenePhylogenyProduct : sampling_set
        
      MetagenomicsGenePhylogenyProduct : summary_metrics
...
<details>
```yaml
name: Metagenomics_GenePhylogenyProduct
description: 'Top-level archive for gene-based phylogeny outputs (zip/tar stored in
  MinIO).
