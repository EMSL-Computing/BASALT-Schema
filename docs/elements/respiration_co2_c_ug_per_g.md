...
URI: [basalt_schema:respiration_co2_c_ug_per_g](https://w3id.org/MONet/basalt-schema/respiration_co2_c_ug_per_g)
...
| ---  | ---  |
| self | basalt_schema:respiration_co2_c_ug_per_g |
| native | basalt_schema:respiration_co2_c_ug_per_g |
