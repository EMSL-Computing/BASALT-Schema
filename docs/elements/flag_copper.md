...
URI: [analysis_api_schema:flag_copper](https://w3id.org/MONet/analysis-api-schema/flag_copper)
Alias: flag_copper
...
| ---  | ---  |
| self | analysis_api_schema:flag_copper |
| native | analysis_api_schema:flag_copper |
