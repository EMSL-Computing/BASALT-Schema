...
URI: [basalt_schema:tortuosity_z](https://emsl-computing.github.io/BASALT-Schema/elements/tortuosity_z)
Alias: tortuosity_z
...
| ---  | ---  |
| self | basalt_schema:tortuosity_z |
| native | basalt_schema:tortuosity_z |
