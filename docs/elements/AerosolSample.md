...
URI: [analysis_api_schema:AerosolSample](https://w3id.org/MONet/analysis-api-schema/AerosolSample)
...
| ---  | ---  |
| self | analysis_api_schema:AerosolSample |
| native | analysis_api_schema:AerosolSample |
