...
# Class: MolecularIdentificationProduct 


_a file containing molecular formula identifications that was output from a mass spec data processing workflow (eg. .csv of m/z and molecular formulae, .hdf5 file)._





URI: [analysis_api_schema:MolecularIdentificationProduct](https://w3id.org/MONet/analysis-api-schema/MolecularIdentificationProduct)
...
```mermaid
 classDiagram
    ...
    click MolecularIdentificationProduct href "../MolecularIdentificationProduct/"
      ...
      MolecularIdentificationProduct : core_section
        
          
    
        
        
        MolecularIdentificationProduct --> "0..1" CoreSectionEnum : core_section
        click CoreSectionEnum href "../CoreSectionEnum/"
    

        
      MolecularIdentificationProduct : description
        
      MolecularIdentificationProduct : filesize
        
      MolecularIdentificationProduct : id
        
      MolecularIdentificationProduct : lims_barcode
        
      MolecularIdentificationProduct : md5checksum
        
      MolecularIdentificationProduct : name
        
      MolecularIdentificationProduct : project
        
      MolecularIdentificationProduct : results_from_ms_processing
        
          
    
        
        
        MolecularIdentificationProduct --> "0..1" MassSpectrometryDataProcessingActivity : results_from_ms_processing
        click MassSpectrometryDataProcessingActivity href "../MassSpectrometryDataProcessingActivity/"
    

        
      MolecularIdentificationProduct : s3_base_url
        
      MolecularIdentificationProduct : s3_bucket
        
      MolecularIdentificationProduct : s3_key
        
      MolecularIdentificationProduct : sample_id
        
          
    
        
        
        MolecularIdentificationProduct --> "0..1" Sample : sample_id
        click Sample href "../Sample/"
    

        
      MolecularIdentificationProduct : sample_name
        
      MolecularIdentificationProduct : sampling_set
        
      MolecularIdentificationProduct : summary_metrics
...
| ---  | ---  |
| self | analysis_api_schema:MolecularIdentificationProduct |
| native | analysis_api_schema:MolecularIdentificationProduct |
...
<details>
```yaml
name: MolecularIdentificationProduct
description: a file containing molecular formula identifications that was output from
  a mass spec data processing workflow (eg. .csv of m/z and molecular formulae, .hdf5
  file).
