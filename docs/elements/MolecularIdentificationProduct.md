...
URI: [basalt_schema:MolecularIdentificationProduct](https://emsl-computing.github.io/BASALT-Schema/elements/MolecularIdentificationProduct)
...
| ---  | ---  |
| self | basalt_schema:MolecularIdentificationProduct |
| native | basalt_schema:MolecularIdentificationProduct |
