...
URI: [basalt_schema:AerosolArmSample](https://emsl-computing.github.io/BASALT-Schema/elements/AerosolArmSample)
...
| ---  | ---  |
| self | basalt_schema:AerosolArmSample |
| native | basalt_schema:AerosolArmSample |
