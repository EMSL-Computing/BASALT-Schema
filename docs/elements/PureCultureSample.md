...
URI: [basalt_schema:PureCultureSample](https://w3id.org/MONet/basalt-schema/PureCultureSample)
...
| ---  | ---  |
| self | basalt_schema:PureCultureSample |
| native | basalt_schema:PureCultureSample |
