...
# Class: PureCultureSample 


_A sample of a culture containing a single organism._





URI: [analysis_api_schema:PureCultureSample](https://w3id.org/MONet/analysis-api-schema/PureCultureSample)
...
```mermaid
 classDiagram
    ...
    click PureCultureSample href "../PureCultureSample/"
      ...
      PureCultureSample : air_temp_regm
        
      PureCultureSample : analysis_type
        
      PureCultureSample : biotic_regm
        
      PureCultureSample : biotic_relationship
        
          
    
        
        
        PureCultureSample --> "0..1" BioticRelationshipEnum : biotic_relationship
        click BioticRelationshipEnum href "../BioticRelationshipEnum/"
    

        
      PureCultureSample : chem_administration
        
      PureCultureSample : description
        
      PureCultureSample : emsl_activity
        
      PureCultureSample : encoded_traits
        
      PureCultureSample : env_broad_scale
        
      PureCultureSample : env_local_scale
        
      PureCultureSample : env_medium
        
      PureCultureSample : experimental_factor
        
      PureCultureSample : experimental_factor_other
        
      PureCultureSample : external_identifiers
        
      PureCultureSample : extraction_method
        
      PureCultureSample : filter_method
        
      PureCultureSample : gaseous_environment
        
      PureCultureSample : genetic_mod
        
      PureCultureSample : growth_medium
        
      PureCultureSample : host_common_name
        
      PureCultureSample : host_spec_range
        
      PureCultureSample : host_taxid
        
      PureCultureSample : humidity_regm
        
      PureCultureSample : id
        
      PureCultureSample : isol_growth_condt
        
      PureCultureSample : isotope_exposure
        
      PureCultureSample : light_regm
        
      PureCultureSample : lims_barcode
        
      PureCultureSample : method_development
        
      PureCultureSample : name
        
      PureCultureSample : non_microb_biomass
        
      PureCultureSample : non_microb_biomass_method
        
      PureCultureSample : other
        
      PureCultureSample : other_samp_store_temp
        
      PureCultureSample : other_storage_condt
        
      PureCultureSample : other_treatment
        
      PureCultureSample : oxygen_relationship
        
          
    
        
        
        PureCultureSample --> "0..1" OxygenStatusEnum : oxygen_relationship
        click OxygenStatusEnum href "../OxygenStatusEnum/"
    

        
      PureCultureSample : pathogenicity
        
      PureCultureSample : project
        
      PureCultureSample : propagation
        
      PureCultureSample : ref_biomaterial
        
      PureCultureSample : replicate_number
        
      PureCultureSample : samp_store_temp
        
          
    
        
        
        PureCultureSample --> "0..1" SampleStoreTempEnum : samp_store_temp
        click SampleStoreTempEnum href "../SampleStoreTempEnum/"
    

        
      PureCultureSample : sample_link
        
      PureCultureSample : sample_name
        
      PureCultureSample : sample_processing
        
      PureCultureSample : sampled_during
        
          
    
        
        
        PureCultureSample --> "0..1" SamplingActivity : sampled_during
        click SamplingActivity href "../SamplingActivity/"
    

        
      PureCultureSample : source_mat_id
        
      PureCultureSample : start_date_inc
        
      PureCultureSample : storage_condition
        
          
    
        
        
        PureCultureSample --> "0..1" StorageConditionEnum : storage_condition
        click StorageConditionEnum href "../StorageConditionEnum/"
    

        
      PureCultureSample : storage_condition_other
        
      PureCultureSample : subspecf_gen_lin
        
      PureCultureSample : technical_reps
        
      PureCultureSample : trophic_level
        
          
    
        
        
        PureCultureSample --> "0..1" TrophicLevelEnum : trophic_level
        click TrophicLevelEnum href "../TrophicLevelEnum/"
    

        
      PureCultureSample : watering_regm
...
| ---  | ---  |
| self | analysis_api_schema:PureCultureSample |
| native | analysis_api_schema:PureCultureSample |
