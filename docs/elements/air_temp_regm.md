...
URI: [basalt_schema:air_temp_regm](https://emsl-computing.github.io/BASALT-Schema/elements/air_temp_regm)
Alias: air_temp_regm
...
| ---  | ---  |
| self | basalt_schema:air_temp_regm |
| native | basalt_schema:air_temp_regm |
| exact | MIXS:0000551 |
