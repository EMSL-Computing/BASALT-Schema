...
URI: [basalt_schema:SynthesizedMaterialSamplingActivity](https://emsl-computing.github.io/BASALT-Schema/elements/SynthesizedMaterialSamplingActivity)
...
| ---  | ---  |
| self | basalt_schema:SynthesizedMaterialSamplingActivity |
| native | basalt_schema:SynthesizedMaterialSamplingActivity |
