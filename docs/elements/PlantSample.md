...
URI: [analysis_api_schema:PlantSample](https://w3id.org/MONet/analysis-api-schema/PlantSample)
...
| ---  | ---  |
| self | analysis_api_schema:PlantSample |
| native | analysis_api_schema:PlantSample |
