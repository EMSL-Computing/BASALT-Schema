...
URI: [basalt_schema:u_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/u_mg_per_kg)
Alias: u_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:u_mg_per_kg |
| native | basalt_schema:u_mg_per_kg |
