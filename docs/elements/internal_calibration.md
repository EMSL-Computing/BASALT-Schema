...
URI: [basalt_schema:internal_calibration](https://emsl-computing.github.io/BASALT-Schema/elements/internal_calibration)
...
| ---  | ---  |
| self | basalt_schema:internal_calibration |
| native | basalt_schema:internal_calibration |
