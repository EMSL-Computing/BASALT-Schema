...
URI: [basalt_schema:SedimentSample](https://emsl-computing.github.io/BASALT-Schema/elements/SedimentSample)
...
| ---  | ---  |
| self | basalt_schema:SedimentSample |
| native | basalt_schema:SedimentSample |
