...
URI: [basalt_schema:XRDDataGenerationActivity](https://w3id.org/MONet/basalt-schema/XRDDataGenerationActivity)
...
| ---  | ---  |
| self | basalt_schema:XRDDataGenerationActivity |
| native | basalt_schema:XRDDataGenerationActivity |
