...
URI: [analysis_api_schema:WaterSamplingActivity](https://w3id.org/MONet/analysis-api-schema/WaterSamplingActivity)
...
| ---  | ---  |
| self | analysis_api_schema:WaterSamplingActivity |
| native | analysis_api_schema:WaterSamplingActivity |
