...
_Collection of samples from a mixed culture._





URI: [analysis_api_schema:MixedCultureSamplingActivity](https://w3id.org/MONet/analysis-api-schema/MixedCultureSamplingActivity)
...
```mermaid
 classDiagram
    ...
    click MixedCultureSamplingActivity href "../MixedCultureSamplingActivity"
      ...
      MixedCultureSamplingActivity : collection_time
        
      MixedCultureSamplingActivity : description
      ...
      MixedCultureSamplingActivity : project
        
      MixedCultureSamplingActivity : sample_collected
        
      MixedCultureSamplingActivity : sample_collection_dev
        
      MixedCultureSamplingActivity : sample_collection_method
        
      MixedCultureSamplingActivity : sampled_at_site
    ...
    click Site href "../Site"
      ...
      MixedCultureSamplingActivity : shipped_sample_size
...
| ---  | ---  |
| self | analysis_api_schema:MixedCultureSamplingActivity |
| native | analysis_api_schema:MixedCultureSamplingActivity |
