...
URI: [basalt_schema:core_group](https://emsl-computing.github.io/BASALT-Schema/elements/core_group)
Alias: core_group
...
| ---  | ---  |
| self | basalt_schema:core_group |
| native | basalt_schema:core_group |
