...
URI: [basalt_schema:cs_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/cs_mg_per_kg)
Alias: cs_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:cs_mg_per_kg |
| native | basalt_schema:cs_mg_per_kg |
