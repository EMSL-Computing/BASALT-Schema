...
URI: [basalt_schema:mo_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/mo_mg_per_kg)
Alias: mo_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:mo_mg_per_kg |
| native | basalt_schema:mo_mg_per_kg |
