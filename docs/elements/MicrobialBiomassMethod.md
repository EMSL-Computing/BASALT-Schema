...
URI: [analysis_api_schema:MicrobialBiomassMethod](https://w3id.org/MONet/analysis-api-schema/MicrobialBiomassMethod)
...
| ---  | ---  |
| self | analysis_api_schema:MicrobialBiomassMethod |
| native | analysis_api_schema:MicrobialBiomassMethod |
