...
URI: [basalt_schema:ga_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/ga_mg_per_kg)
Alias: ga_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:ga_mg_per_kg |
| native | basalt_schema:ga_mg_per_kg |
