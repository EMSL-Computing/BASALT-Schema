...
_Gallium concentration in mg/kg_





URI: [analysis_api_schema:ga_mg_per_kg](https://w3id.org/MONet/analysis-api-schema/ga_mg_per_kg)
Alias: ga_mg_per_kg
...
| ---  | ---  |
| self | analysis_api_schema:ga_mg_per_kg |
| native | analysis_api_schema:ga_mg_per_kg |
