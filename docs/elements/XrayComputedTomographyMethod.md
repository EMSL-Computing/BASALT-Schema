...
URI: [analysis_api_schema:XrayComputedTomographyMethod](https://w3id.org/MONet/analysis-api-schema/XrayComputedTomographyMethod)
...
| ---  | ---  |
| self | analysis_api_schema:XrayComputedTomographyMethod |
| native | analysis_api_schema:XrayComputedTomographyMethod |
