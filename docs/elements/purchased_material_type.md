...
URI: [analysis_api_schema:purchased_material_type](https://w3id.org/MONet/analysis-api-schema/purchased_material_type)
...
| ---  | ---  |
| self | analysis_api_schema:purchased_material_type |
| native | analysis_api_schema:purchased_material_type |
