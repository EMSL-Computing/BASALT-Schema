...
URI: [analysis_api_schema:MetagenomicsProduct](https://w3id.org/MONet/analysis-api-schema/MetagenomicsProduct)
...
| ---  | ---  |
| self | analysis_api_schema:MetagenomicsProduct |
| native | analysis_api_schema:MetagenomicsProduct |
