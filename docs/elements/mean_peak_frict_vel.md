...
_Measurement of mean peak friction velocity (Unit: m/s)_





URI: [basalt_schema:mean_peak_frict_vel](https://emsl-computing.github.io/BASALT-Schema/elements/mean_peak_frict_vel)
