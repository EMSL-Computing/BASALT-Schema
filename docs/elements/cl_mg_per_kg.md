...
URI: [basalt_schema:cl_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/cl_mg_per_kg)
Alias: cl_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:cl_mg_per_kg |
| native | basalt_schema:cl_mg_per_kg |
