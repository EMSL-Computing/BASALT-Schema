...
URI: [basalt_schema:as_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/as_mg_per_kg)
Alias: as_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:as_mg_per_kg |
| native | basalt_schema:as_mg_per_kg |
