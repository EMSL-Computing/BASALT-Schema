...
URI: [basalt_schema:pb_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/pb_mg_per_kg)
Alias: pb_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:pb_mg_per_kg |
| native | basalt_schema:pb_mg_per_kg |
