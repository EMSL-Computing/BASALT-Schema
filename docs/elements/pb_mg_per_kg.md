...
_Lead concentration in mg/kg_





URI: [analysis_api_schema:pb_mg_per_kg](https://w3id.org/MONet/analysis-api-schema/pb_mg_per_kg)
Alias: pb_mg_per_kg
...
| ---  | ---  |
| self | analysis_api_schema:pb_mg_per_kg |
| native | analysis_api_schema:pb_mg_per_kg |
