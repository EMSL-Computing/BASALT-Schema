...
URI: [analysis_api_schema:EngineeredStrainSamplingActivity](https://w3id.org/MONet/analysis-api-schema/EngineeredStrainSamplingActivity)
...
| ---  | ---  |
| self | analysis_api_schema:EngineeredStrainSamplingActivity |
| native | analysis_api_schema:EngineeredStrainSamplingActivity |
