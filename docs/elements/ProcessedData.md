...
URI: [basalt_schema:ProcessedData](https://emsl-computing.github.io/BASALT-Schema/elements/ProcessedData)
...
| ---  | ---  |
| self | basalt_schema:ProcessedData |
| native | basalt_schema:ProcessedData |
