...
URI: [analysis_api_schema:sample_start_time](https://w3id.org/MONet/analysis-api-schema/sample_start_time)
...
| ---  | ---  |
| self | analysis_api_schema:sample_start_time |
| native | analysis_api_schema:sample_start_time |
