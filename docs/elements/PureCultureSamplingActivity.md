...
# Class: PureCultureSamplingActivity 


_Collection of samples from a culture containing a single organism._





URI: [analysis_api_schema:PureCultureSamplingActivity](https://w3id.org/MONet/analysis-api-schema/PureCultureSamplingActivity)
...
```mermaid
 classDiagram
    ...
    click PureCultureSamplingActivity href "../PureCultureSamplingActivity/"
      ...
      PureCultureSamplingActivity : collection_date
        
      PureCultureSamplingActivity : collection_time
        
      PureCultureSamplingActivity : description
        
      PureCultureSamplingActivity : emsl_activity
        
      PureCultureSamplingActivity : id
        
      PureCultureSamplingActivity : name
        
      PureCultureSamplingActivity : project
        
      PureCultureSamplingActivity : sample_collected
        
      PureCultureSamplingActivity : sample_collection_dev
        
      PureCultureSamplingActivity : sample_collection_method
        
      PureCultureSamplingActivity : sampled_at_site
        
          
    
        
        
        PureCultureSamplingActivity --> "0..1" Site : sampled_at_site
        click Site href "../Site/"
    

        
      PureCultureSamplingActivity : shipped_sample_size
...
| ---  | ---  |
| self | analysis_api_schema:PureCultureSamplingActivity |
| native | analysis_api_schema:PureCultureSamplingActivity |
...
<details>
```yaml
name: PureCultureSamplingActivity
description: Collection of samples from a culture containing a single organism.
...
attributes:
  id:
    ...
    identifier: true
    alias: id
    owner: PureCultureSamplingActivity
    domain_of:
    - Activity
    - Entity
    - DataProduct
