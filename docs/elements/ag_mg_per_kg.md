...
URI: [basalt_schema:ag_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/ag_mg_per_kg)
Alias: ag_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:ag_mg_per_kg |
| native | basalt_schema:ag_mg_per_kg |
