...
# Slot: frames_recording_per_projection 



URI: [basalt_schema:frames_recording_per_projection](https://EMSL-Computing.github.io/BASALT-Schema/frames_recording_per_projection)
