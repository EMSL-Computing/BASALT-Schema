...
URI: [basalt_schema:flag_mbn_avg](https://emsl-computing.github.io/BASALT-Schema/elements/flag_mbn_avg)
Alias: flag_mbn_avg
...
| ---  | ---  |
| self | basalt_schema:flag_mbn_avg |
| native | basalt_schema:flag_mbn_avg |
