...
URI: [analysis_api_schema:measurement_type](https://w3id.org/MONet/analysis-api-schema/measurement_type)
...
| ---  | ---  |
| self | analysis_api_schema:measurement_type |
| native | analysis_api_schema:measurement_type |
