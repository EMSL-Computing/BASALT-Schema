...
URI: [basalt_schema:BulkDensityProduct](https://emsl-computing.github.io/BASALT-Schema/elements/BulkDensityProduct)
...
```mermaid
 classDiagram
    ...
    click BulkDensityProduct href "../BulkDensityProduct/"
      ...
      BulkDensityProduct : bulk_density_id
        
          
    
        
        
        BulkDensityProduct --> "0..1" QuantityValue : bulk_density_id
        click QuantityValue href "../QuantityValue/"
    

        
      BulkDensityProduct : core_section
        
          
    
        
        
        BulkDensityProduct --> "0..1" CoreSectionEnum : core_section
        click CoreSectionEnum href "../CoreSectionEnum/"
    

        
      BulkDensityProduct : description
        
      BulkDensityProduct : filesize
        
      BulkDensityProduct : flag
        
          
    
        
        
        BulkDensityProduct --> "0..1" ProcessedDataFlag : flag
        click ProcessedDataFlag href "../ProcessedDataFlag/"
    

        
      BulkDensityProduct : id
        
      BulkDensityProduct : lims_barcode
        
      BulkDensityProduct : md5checksum
        
      BulkDensityProduct : measure_type
        
          
    
        
        
        BulkDensityProduct --> "0..1" ProductMeasureType : measure_type
        click ProductMeasureType href "../ProductMeasureType/"
    

        
      BulkDensityProduct : name
        
      BulkDensityProduct : project
        
      BulkDensityProduct : s3_base_url
        
      BulkDensityProduct : s3_bucket
        
      BulkDensityProduct : s3_key
        
      BulkDensityProduct : sample_id
        
          
    
        
        
        BulkDensityProduct --> "0..1" Sample : sample_id
        click Sample href "../Sample/"
    

        
      BulkDensityProduct : sample_name
        
      BulkDensityProduct : sampling_set
        
      BulkDensityProduct : summary_metrics
...
| [bulk_density_id](bulk_density_id.md) | 0..1 <br/> [QuantityValue](QuantityValue.md) |  | direct |
...
| ---  | ---  |
| self | basalt_schema:BulkDensityProduct |
| native | basalt_schema:BulkDensityProduct |
