...
# Slot: cation_exchange_capacity_id 



URI: [basalt_schema:cation_exchange_capacity_id](https://emsl-computing.github.io/BASALT-Schema/elements/cation_exchange_capacity_id)
