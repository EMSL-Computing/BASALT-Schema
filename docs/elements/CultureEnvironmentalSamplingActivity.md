...
# Class: CultureEnvironmentalSamplingActivity 


_Collection of samples from a culture of organisms taken from the environment._





URI: [basalt_schema:CultureEnvironmentalSamplingActivity](https://w3id.org/MONet/basalt-schema/CultureEnvironmentalSamplingActivity)
...
```mermaid
 classDiagram
    ...
    click CultureEnvironmentalSamplingActivity href "../CultureEnvironmentalSamplingActivity/"
      ...
      CultureEnvironmentalSamplingActivity : collection_date
        
      CultureEnvironmentalSamplingActivity : collection_time
        
      CultureEnvironmentalSamplingActivity : description
        
      CultureEnvironmentalSamplingActivity : emsl_activity
        
      CultureEnvironmentalSamplingActivity : id
        
      CultureEnvironmentalSamplingActivity : name
        
      CultureEnvironmentalSamplingActivity : project
        
      CultureEnvironmentalSamplingActivity : sample_collected
        
      CultureEnvironmentalSamplingActivity : sample_collection_dev
        
      CultureEnvironmentalSamplingActivity : sample_collection_method
        
      CultureEnvironmentalSamplingActivity : sampled_at_site
        
          
    
        
        
        CultureEnvironmentalSamplingActivity --> "0..1" Site : sampled_at_site
        click Site href "../Site/"
    

        
      CultureEnvironmentalSamplingActivity : shipped_sample_size
