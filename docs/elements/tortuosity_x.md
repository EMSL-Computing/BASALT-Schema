...
URI: [basalt_schema:tortuosity_x](https://EMSL-Computing.github.io/basalt-schema/tortuosity_x)
Alias: tortuosity_x
...
| ---  | ---  |
| self | basalt_schema:tortuosity_x |
| native | basalt_schema:tortuosity_x |
