...
_Rubidium concentration in mg/kg_





URI: [analysis_api_schema:rb_mg_per_kg](https://w3id.org/MONet/analysis-api-schema/rb_mg_per_kg)
Alias: rb_mg_per_kg
...
| ---  | ---  |
| self | analysis_api_schema:rb_mg_per_kg |
| native | analysis_api_schema:rb_mg_per_kg |
