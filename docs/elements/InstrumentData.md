...
URI: [analysis_api_schema:InstrumentData](https://w3id.org/MONet/analysis-api-schema/InstrumentData)
...
| ---  | ---  |
| self | analysis_api_schema:InstrumentData |
| native | analysis_api_schema:InstrumentData |
