...
URI: [analysis_api_schema:OtherUndescribedSamplingActivity](https://w3id.org/MONet/analysis-api-schema/OtherUndescribedSamplingActivity)
...
| ---  | ---  |
| self | analysis_api_schema:OtherUndescribedSamplingActivity |
| native | analysis_api_schema:OtherUndescribedSamplingActivity |
