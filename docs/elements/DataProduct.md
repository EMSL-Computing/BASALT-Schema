...
URI: [basalt_schema:DataProduct](https://EMSL-Computing.github.io/basalt-schema/DataProduct)
...
```mermaid
 classDiagram
    ...
    click DataProduct href "../DataProduct/"
      ...
      DataProduct : s3_base_url
        
      DataProduct : s3_bucket
        
      DataProduct : s3_key
        
      DataProduct : sample_name
        
      DataProduct : sampling_set
