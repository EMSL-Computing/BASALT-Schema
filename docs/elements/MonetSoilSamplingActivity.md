...
URI: [analysis_api_schema:MonetSoilSamplingActivity](https://w3id.org/MONet/analysis-api-schema/MonetSoilSamplingActivity)
...
| ---  | ---  |
| self | analysis_api_schema:MonetSoilSamplingActivity |
| native | analysis_api_schema:MonetSoilSamplingActivity |
