...
URI: [basalt_schema:cd_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/cd_mg_per_kg)
Alias: cd_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:cd_mg_per_kg |
| native | basalt_schema:cd_mg_per_kg |
