...
# Class: FieldDeployedTerraformSamplingActivity 


_Collection of samples from a field-deployed Terraform device._





URI: [basalt_schema:FieldDeployedTerraformSamplingActivity](https://emsl-computing.github.io/BASALT-Schema/elements/FieldDeployedTerraformSamplingActivity)
...
```mermaid
 classDiagram
    ...
    click FieldDeployedTerraformSamplingActivity href "../FieldDeployedTerraformSamplingActivity/"
      ...
      FieldDeployedTerraformSamplingActivity : collection_date
        
      FieldDeployedTerraformSamplingActivity : collection_time
        
      FieldDeployedTerraformSamplingActivity : description
        
      FieldDeployedTerraformSamplingActivity : emsl_activity
        
      FieldDeployedTerraformSamplingActivity : id
        
      FieldDeployedTerraformSamplingActivity : name
        
      FieldDeployedTerraformSamplingActivity : project
        
      FieldDeployedTerraformSamplingActivity : sample_collected
        
      FieldDeployedTerraformSamplingActivity : sample_collection_method
        
      FieldDeployedTerraformSamplingActivity : sampled_at_site
        
          
    
        
        
        FieldDeployedTerraformSamplingActivity --> "0..1" Site : sampled_at_site
        click Site href "../Site/"
    

        
      FieldDeployedTerraformSamplingActivity : shipped_sample_size
