...
URI: [analysis_api_schema:soluble_inorg_mat](https://w3id.org/MONet/analysis-api-schema/soluble_inorg_mat)
...
| ---  | ---  |
| self | analysis_api_schema:soluble_inorg_mat |
| native | analysis_api_schema:soluble_inorg_mat |
