...
_Top-level archive (zip/tar) for binning results stored in MinIO._
...
URI: [analysis_api_schema:MetagenomicsBinningProduct](https://w3id.org/MONet/analysis-api-schema/MetagenomicsBinningProduct)
...
```mermaid
 classDiagram
    ...
    click MetagenomicsBinningProduct href "../MetagenomicsBinningProduct/"
      ...
      MetagenomicsBinningProduct : core_section
      ...
      MetagenomicsBinningProduct : description
        
      MetagenomicsBinningProduct : filesize
      ...
      MetagenomicsBinningProduct : mg_workflow_step
      ...
      MetagenomicsBinningProduct : name
        
      MetagenomicsBinningProduct : project
        
      MetagenomicsBinningProduct : provider_name
      ...
      MetagenomicsBinningProduct : raw_fasta_url
        
      MetagenomicsBinningProduct : s3_base_url
        
      MetagenomicsBinningProduct : s3_bucket
        
      MetagenomicsBinningProduct : s3_key
        
      MetagenomicsBinningProduct : sample_id
      ...
      MetagenomicsBinningProduct : sample_name
        
      MetagenomicsBinningProduct : sampling_set
        
      MetagenomicsBinningProduct : summary_metrics
...
| ---  | ---  |
| self | analysis_api_schema:MetagenomicsBinningProduct |
| native | analysis_api_schema:MetagenomicsBinningProduct |
...
<details>
```yaml
name: Metagenomics_BinningProduct
