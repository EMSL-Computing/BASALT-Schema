...
URI: [basalt_schema:WaterSample](https://emsl-computing.github.io/BASALT-Schema/elements/WaterSample)
...
| ---  | ---  |
| self | basalt_schema:WaterSample |
| native | basalt_schema:WaterSample |
