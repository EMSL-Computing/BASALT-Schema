...
_Tin concentration in mg/kg_





URI: [analysis_api_schema:sn_mg_per_kg](https://w3id.org/MONet/analysis-api-schema/sn_mg_per_kg)
Alias: sn_mg_per_kg
...
| ---  | ---  |
| self | analysis_api_schema:sn_mg_per_kg |
| native | analysis_api_schema:sn_mg_per_kg |
