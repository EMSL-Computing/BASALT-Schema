...
URI: [basalt_schema:sn_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/sn_mg_per_kg)
Alias: sn_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:sn_mg_per_kg |
| native | basalt_schema:sn_mg_per_kg |
