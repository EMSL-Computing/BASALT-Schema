...
URI: [basalt_schema:MassSpectrometryDataProduct](https://emsl-computing.github.io/BASALT-Schema/elements/MassSpectrometryDataProduct)
...
| ---  | ---  |
| self | basalt_schema:MassSpectrometryDataProduct |
| native | basalt_schema:MassSpectrometryDataProduct |
