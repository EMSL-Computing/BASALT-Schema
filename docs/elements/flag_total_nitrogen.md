...
URI: [basalt_schema:flag_total_nitrogen](https://w3id.org/MONet/basalt-schema/flag_total_nitrogen)
...
| ---  | ---  |
| self | basalt_schema:flag_total_nitrogen |
| native | basalt_schema:flag_total_nitrogen |
