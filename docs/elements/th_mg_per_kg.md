...
_Thorium concentration in mg/kg_





URI: [analysis_api_schema:th_mg_per_kg](https://w3id.org/MONet/analysis-api-schema/th_mg_per_kg)
Alias: th_mg_per_kg
...
| ---  | ---  |
| self | analysis_api_schema:th_mg_per_kg |
| native | analysis_api_schema:th_mg_per_kg |
