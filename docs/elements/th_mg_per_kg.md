...
URI: [basalt_schema:th_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/th_mg_per_kg)
Alias: th_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:th_mg_per_kg |
| native | basalt_schema:th_mg_per_kg |
