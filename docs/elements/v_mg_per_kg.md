...
URI: [basalt_schema:v_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/v_mg_per_kg)
Alias: v_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:v_mg_per_kg |
| native | basalt_schema:v_mg_per_kg |
