...
URI: [basalt_schema:other_properties](https://emsl-computing.github.io/BASALT-Schema/elements/other_properties)
...
| ---  | ---  |
| self | basalt_schema:other_properties |
| native | basalt_schema:other_properties |
