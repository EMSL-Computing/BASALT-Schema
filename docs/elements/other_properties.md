...
# Slot: other_properties 


_Other important properties of the instrument that are not captured in other fields._





URI: [analysis_api_schema:other_properties](https://w3id.org/MONet/analysis-api-schema/other_properties)
...
| ---  | ---  |
| self | analysis_api_schema:other_properties |
| native | analysis_api_schema:other_properties |
