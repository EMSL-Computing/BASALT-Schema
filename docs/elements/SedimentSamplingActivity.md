...
_Collection of sediment samples from the environment._





URI: [analysis_api_schema:SedimentSamplingActivity](https://w3id.org/MONet/analysis-api-schema/SedimentSamplingActivity)
...
```mermaid
 classDiagram
    ...
    click SedimentSamplingActivity href "../SedimentSamplingActivity/"
      ...
      SedimentSamplingActivity : collection_time
        
      SedimentSamplingActivity : description
      ...
      SedimentSamplingActivity : project
        
      SedimentSamplingActivity : sample_collected
        
      SedimentSamplingActivity : sample_collection_dev
        
      SedimentSamplingActivity : sample_collection_method
        
      SedimentSamplingActivity : sampled_at_site
      ...
      SedimentSamplingActivity : shipped_sample_size
        
      SedimentSamplingActivity : weather
...
| ---  | ---  |
| self | analysis_api_schema:SedimentSamplingActivity |
| native | analysis_api_schema:SedimentSamplingActivity |
