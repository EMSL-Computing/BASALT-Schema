...
URI: [basalt_schema:SedimentSamplingActivity](https://emsl-computing.github.io/BASALT-Schema/elements/SedimentSamplingActivity)
...
| ---  | ---  |
| self | basalt_schema:SedimentSamplingActivity |
| native | basalt_schema:SedimentSamplingActivity |
