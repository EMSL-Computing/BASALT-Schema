...
URI: [basalt_schema:FieldDeployedTerraformSample](https://emsl-computing.github.io/BASALT-Schema/elements/FieldDeployedTerraformSample)
...
| ---  | ---  |
| self | basalt_schema:FieldDeployedTerraformSample |
| native | basalt_schema:FieldDeployedTerraformSample |
