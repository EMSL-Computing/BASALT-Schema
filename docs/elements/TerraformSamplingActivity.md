...
_Collection of samples from a Terraform device._





URI: [basalt_schema:TerraformSamplingActivity](https://emsl-computing.github.io/BASALT-Schema/elements/TerraformSamplingActivity)
...
```mermaid
 classDiagram
    ...
    click TerraformSamplingActivity href "../TerraformSamplingActivity/"
      ...
      TerraformSamplingActivity : collection_time
        
      TerraformSamplingActivity : description
      ...
      TerraformSamplingActivity : project
        
      TerraformSamplingActivity : sample_collected
        
      TerraformSamplingActivity : sample_collection_method
        
      TerraformSamplingActivity : sampled_at_site
      ...
      TerraformSamplingActivity : shipped_sample_size
