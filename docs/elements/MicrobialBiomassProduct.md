...
URI: [basalt_schema:MicrobialBiomassProduct](https://EMSL-Computing.github.io/basalt-schema/MicrobialBiomassProduct)
...
```mermaid
 classDiagram
    ...
    click MicrobialBiomassProduct href "../MicrobialBiomassProduct/"
      ...
      MicrobialBiomassProduct : core_section
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" CoreSectionEnum : core_section
        click CoreSectionEnum href "../CoreSectionEnum/"
    

        
      MicrobialBiomassProduct : description
        
      MicrobialBiomassProduct : filesize
        
      MicrobialBiomassProduct : flag_mbc
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" ProcessedDataFlag : flag_mbc
        click ProcessedDataFlag href "../ProcessedDataFlag/"
    

        
      MicrobialBiomassProduct : flag_mbc_avg
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" ProcessedDataFlag : flag_mbc_avg
        click ProcessedDataFlag href "../ProcessedDataFlag/"
    

        
      MicrobialBiomassProduct : flag_mbn
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" ProcessedDataFlag : flag_mbn
        click ProcessedDataFlag href "../ProcessedDataFlag/"
    

        
      MicrobialBiomassProduct : flag_mbn_avg
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" ProcessedDataFlag : flag_mbn_avg
        click ProcessedDataFlag href "../ProcessedDataFlag/"
    

        
      MicrobialBiomassProduct : id
        
      MicrobialBiomassProduct : lims_barcode
        
      MicrobialBiomassProduct : mbc_avg
        
      MicrobialBiomassProduct : mbc_id
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" QuantityValue : mbc_id
        click QuantityValue href "../QuantityValue/"
    

        
      MicrobialBiomassProduct : mbn_avg
        
      MicrobialBiomassProduct : mbn_id
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" QuantityValue : mbn_id
        click QuantityValue href "../QuantityValue/"
    

        
      MicrobialBiomassProduct : md5checksum
        
      MicrobialBiomassProduct : measure_type
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" ProductMeasureType : measure_type
        click ProductMeasureType href "../ProductMeasureType/"
    

        
      MicrobialBiomassProduct : name
        
      MicrobialBiomassProduct : project
        
      MicrobialBiomassProduct : replicate
        
      MicrobialBiomassProduct : s3_base_url
        
      MicrobialBiomassProduct : s3_bucket
        
      MicrobialBiomassProduct : s3_key
        
      MicrobialBiomassProduct : sample_id
        
          
    
        
        
        MicrobialBiomassProduct --> "0..1" Sample : sample_id
        click Sample href "../Sample/"
    

        
      MicrobialBiomassProduct : sample_name
        
      MicrobialBiomassProduct : sampling_set
        
      MicrobialBiomassProduct : summary_metrics
...
| [mbc_id](mbc_id.md) | 0..1 <br/> [QuantityValue](QuantityValue.md) |  | direct |
| [mbc_avg](mbc_avg.md) | 0..1 <br/> [Double](Double.md) |  | direct |
| [mbn_id](mbn_id.md) | 0..1 <br/> [QuantityValue](QuantityValue.md) |  | direct |
| [mbn_avg](mbn_avg.md) | 0..1 <br/> [Double](Double.md) |  | direct |
| [flag_mbc](flag_mbc.md) | 0..1 <br/> [ProcessedDataFlag](ProcessedDataFlag.md) |  | direct |
| [flag_mbn](flag_mbn.md) | 0..1 <br/> [ProcessedDataFlag](ProcessedDataFlag.md) |  | direct |
| [flag_mbc_avg](flag_mbc_avg.md) | 0..1 <br/> [ProcessedDataFlag](ProcessedDataFlag.md) |  | direct |
| [flag_mbn_avg](flag_mbn_avg.md) | 0..1 <br/> [ProcessedDataFlag](ProcessedDataFlag.md) |  | direct |
