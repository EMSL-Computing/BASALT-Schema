...
_Collection of samples that were purchased by the user._





URI: [analysis_api_schema:CommerciallyPurchasedSamplingActivity](https://w3id.org/MONet/analysis-api-schema/CommerciallyPurchasedSamplingActivity)
...
```mermaid
 classDiagram
    ...
    click CommerciallyPurchasedSamplingActivity href "../CommerciallyPurchasedSamplingActivity/"
      ...
      CommerciallyPurchasedSamplingActivity : description
      ...
      CommerciallyPurchasedSamplingActivity : project
        
      CommerciallyPurchasedSamplingActivity : sample_collected
        
      CommerciallyPurchasedSamplingActivity : sample_collection_dev
        
      CommerciallyPurchasedSamplingActivity : sampled_at_site
      ...
      CommerciallyPurchasedSamplingActivity : shipped_sample_size
...
| ---  | ---  |
| self | analysis_api_schema:CommerciallyPurchasedSamplingActivity |
| native | analysis_api_schema:CommerciallyPurchasedSamplingActivity |
