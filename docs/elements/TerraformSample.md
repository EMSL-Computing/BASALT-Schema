...
URI: [basalt_schema:TerraformSample](https://emsl-computing.github.io/BASALT-Schema/elements/TerraformSample)
...
| ---  | ---  |
| self | basalt_schema:TerraformSample |
| native | basalt_schema:TerraformSample |
