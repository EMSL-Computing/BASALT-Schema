...
URI: [basalt_schema:NucleotideSequencingInstrumentData](https://emsl-computing.github.io/BASALT-Schema/elements/NucleotideSequencingInstrumentData)
...
| ---  | ---  |
| self | basalt_schema:NucleotideSequencingInstrumentData |
| native | basalt_schema:NucleotideSequencingInstrumentData |
