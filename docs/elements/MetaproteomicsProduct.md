...
_Abstract parent class for processed metaproteomics data. Details and subclasses TBD._
...
URI: [basalt_schema:MetaproteomicsProduct](https://emsl-computing.github.io/BASALT-Schema/elements/MetaproteomicsProduct)
...
```mermaid
 classDiagram
    ...
    click MetaproteomicsProduct href "../MetaproteomicsProduct/"
      ...
      MetaproteomicsProduct : description
      ...
      MetaproteomicsProduct : md5checksum
        
      MetaproteomicsProduct : name
        
      MetaproteomicsProduct : project
        
      MetaproteomicsProduct : results_from_ms_processing
      ...
      MetaproteomicsProduct : s3_base_url
        
      MetaproteomicsProduct : s3_bucket
        
      MetaproteomicsProduct : s3_key
        
      MetaproteomicsProduct : sample_id
      ...
      MetaproteomicsProduct : sample_name
        
      MetaproteomicsProduct : sampling_set
        
      MetaproteomicsProduct : summary_metrics
