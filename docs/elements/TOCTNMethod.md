...
URI: [analysis_api_schema:TOCTNMethod](https://w3id.org/MONet/analysis-api-schema/TOCTNMethod)
...
| ---  | ---  |
| self | analysis_api_schema:TOCTNMethod |
| native | analysis_api_schema:TOCTNMethod |
