...
# Slot: total_carbon_id 



URI: [analysis_api_schema:total_carbon_id](https://w3id.org/MONet/analysis-api-schema/total_carbon_id)
...
| ---  | ---  |
| self | analysis_api_schema:total_carbon_id |
| native | analysis_api_schema:total_carbon_id |
