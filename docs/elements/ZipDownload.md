...
URI: [basalt_schema:ZipDownload](https://w3id.org/MONet/basalt-schema/ZipDownload)
...
| ---  | ---  |
| self | basalt_schema:ZipDownload |
| native | basalt_schema:ZipDownload |
...
attributes:
  id:
    name: id
    from_schema: https://w3id.org/MONet/basalt-schema/zip_download
    identifier: true
    domain_of:
    - Activity
    - Entity
