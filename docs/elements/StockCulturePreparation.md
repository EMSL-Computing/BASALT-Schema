...
URI: [analysis_api_schema:StockCulturePreparation](https://w3id.org/MONet/analysis-api-schema/StockCulturePreparation)
...
| ---  | ---  |
| self | analysis_api_schema:StockCulturePreparation |
| native | analysis_api_schema:StockCulturePreparation |
