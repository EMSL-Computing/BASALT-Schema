...
URI: [basalt_schema:flag_mbc_avg](https://EMSL-Computing.github.io/BASALT-Schema/flag_mbc_avg)
Alias: flag_mbc_avg
...
| ---  | ---  |
| self | basalt_schema:flag_mbc_avg |
| native | basalt_schema:flag_mbc_avg |
