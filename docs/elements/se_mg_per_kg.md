...
URI: [basalt_schema:se_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/se_mg_per_kg)
Alias: se_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:se_mg_per_kg |
| native | basalt_schema:se_mg_per_kg |
