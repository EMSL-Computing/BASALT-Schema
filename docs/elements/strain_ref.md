...
_FK reference to a Strain purchasedMaterial used in the activity_





URI: [basalt_schema:strain_ref](https://emsl-computing.github.io/BASALT-Schema/elements/strain_ref)
Alias: strain_ref
