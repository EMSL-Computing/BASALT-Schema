...
URI: [analysis_api_schema:cult_root_med](https://w3id.org/MONet/analysis-api-schema/cult_root_med)
Alias: cult_root_med
...
| ---  | ---  |
| self | analysis_api_schema:cult_root_med |
| native | analysis_api_schema:cult_root_med |
