...
URI: [basalt_schema:y_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/y_mg_per_kg)
Alias: y_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:y_mg_per_kg |
| native | basalt_schema:y_mg_per_kg |
