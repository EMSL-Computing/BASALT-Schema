...
URI: [basalt_schema:zn_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/zn_mg_per_kg)
Alias: zn_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:zn_mg_per_kg |
| native | basalt_schema:zn_mg_per_kg |
