...
URI: [analysis_api_schema:MonetSoilSample](https://w3id.org/MONet/analysis-api-schema/MonetSoilSample)
...
| ---  | ---  |
| self | analysis_api_schema:MonetSoilSample |
| native | analysis_api_schema:MonetSoilSample |
