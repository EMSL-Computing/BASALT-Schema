...
URI: [analysis_api_schema:antibiotic_regm](https://w3id.org/MONet/analysis-api-schema/antibiotic_regm)
...
| ---  | ---  |
| self | analysis_api_schema:antibiotic_regm |
| native | analysis_api_schema:antibiotic_regm |
