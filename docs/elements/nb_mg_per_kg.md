...
URI: [basalt_schema:nb_mg_per_kg](https://emsl-computing.github.io/BASALT-Schema/elements/nb_mg_per_kg)
Alias: nb_mg_per_kg
...
| ---  | ---  |
| self | basalt_schema:nb_mg_per_kg |
| native | basalt_schema:nb_mg_per_kg |
