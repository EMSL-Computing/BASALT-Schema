...
URI: [basalt_schema:activity_time_id](https://w3id.org/MONet/basalt-schema/activity_time_id)
...
| ---  | ---  |
| self | basalt_schema:activity_time_id |
| native | basalt_schema:activity_time_id |
