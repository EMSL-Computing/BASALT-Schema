...
URI: [basalt_schema:season_temp](https://emsl-computing.github.io/BASALT-Schema/elements/season_temp)
Alias: season_temp
...
| ---  | ---  |
| self | basalt_schema:season_temp |
| native | basalt_schema:season_temp |
